...
<br></br>
    ...
    <h2 class="title"><a href="#">Room Reserve</a></h2>
					...
					<div class="entry">
		<p> <form method="post" text-color:'red' action="ReserveHandler">
...
%>
 ...
 <tr>
    	<td> Address 	:</td>
    	<td><input type="text area" name="address" value=""></td>
 </tr>   
 ...
 <tr>
  ...
  <td>Room Type	:
   ...
   <td> <select type="textbox" name="room" value="">
...
<option value="Room Type"></option>
 ...
 <tr>
 		<td>No Of Beds : </td>  
		<td> <select type="textbox" name="Beds" value="">
