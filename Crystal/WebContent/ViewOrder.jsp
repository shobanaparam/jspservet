...
<%
    	                                   	try{
    	                                   		Connection con = DbConnection.getDBConnection(); 
    	                                   	 		        Statement myStm= con.createStatement();
    	                                   	 		       	...
    	                                   	 		       	String query  ="SELECT * FROM logintemp l, Order1 o where o.UserName = l.UserName";
          ...
          <br>
                                <tr>
                                  <td><a href="EditOrder.jsp?id=<%=resultSet.getString("UserName")%>"><button class="update" type="button">Edit Details</button></a></td>  
      						      <td><a href="DeleteOrderHandler?id=<%=resultSet.getString("UserName")%>"><button class="delete" type="button">Cancel Booking</button></a></td>
      						      <td><a href="FoodPayment.jsp"><button type="button">View Order Payment</button></td>  
       						   </tr>
